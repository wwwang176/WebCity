...
- [ ] **路線的載重率凍結在玩家上次動路網的那一刻**（BUG-343）— `headway` 與
  ...
  當下真正的載重率 **308**。
  **修法會動平衡** —— 接上活的載重率，公車會當場對所有人關閉。要跟 BUG-344 一起處理。
- [ ] **一班公車跑完一圈要六個遊戲日**（BUG-344）— 路線 282 格、車速 2 格/tick、
  一圈 141 tick，而一天只有 24 tick，一天跑 **0.17 圈**。50 座的公車一天的運能因此
  只有 **8.5 人次**，任何路線超過約 9 人次就爆表。運能公式的單位是對的，錯的是刻度。
  可動的旋鈕:車速、`ticksPerDay`、座位數，或讓運能不跟「一天跑幾圈」綁在一起。
- [ ] **面板的 Usage 用錯單位，收合之後還夾在 100%**（BUG-342）— 面板拿
