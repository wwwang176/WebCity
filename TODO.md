...
- [ ] **`advanceEdgeVehicles` 仍是最大的一塊** — 870 台車、每幀約 10ms。分段:主迴圈
  144.8ms/tick（其中 `findGapAhead` 39.8、`findBlockedJunctionDistance` 11.9）、
  排序 30.2、索引重建 29.3+11.7。排序是每幀對全部車做一次 O(n log n)。
