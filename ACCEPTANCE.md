...
- [x] RCI 指標條隨模擬即時更新
- [x] 預算面板數字與模擬狀態一致
- [ ] 稅率滑桿拖動 → 即時生效 ⚠️ 稅率滑桿 UI 未實現
- [x] 速度按鈕：暫停/1x/2x/3x 正確切換
- [ ] 通知系統：里程碑達成時彈出通知 ⚠️ BUG-020: 里程碑通知系統未實現

### 視覺驗收

- [x] UI 不遮擋過多遊戲畫面
- [ ] 面板可展開/收合 ⚠️ UI 面板無展開/收合功能
- [x] 文字清晰可讀
- [ ] 圖表曲線平滑 ⚠️ 無圖表功能
...
- [ ] 拖曳建路時顯示預覽線（半透明）⚠️ BUG-022: 未實現
- [ ] 拖曳建路時顯示預估成本 ⚠️ BUG-022: 未實現
- [x] 按 ESC 取消當前操作
- [x] 按 Delete 啟動拆除模式
- [ ] 拆除前高亮紅色 ⚠️ 未實現拆除預覽高亮
...
- [ ] 進入遊戲 → 背景音樂播放 ⚠️ 無背景音樂（只有音效）
- [x] 建路操作 → 建設音效播放 ✅ BUG-017 已修復
- [x] 拆除操作 → 拆除音效播放 ✅ BUG-017 已修復
- [ ] 災害發生 → 警報音效播放 ⚠️ 災害系統未整合到遊戲循環
