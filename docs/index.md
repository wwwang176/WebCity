...
| [transfer-system.md](transfer-system.md) | 多模式轉乘 — TransferGraph、站對站快取、路線搜尋、TransferTracker、覆蓋 UI |
...
| [agent-api.md](agent-api.md) | Agent API — `window.__agent` 與 `POST /agent`，讓程式（或另一個 AI）玩這個遊戲 |
