...
describe('ElevationManager', () => {
  ...
  describe('get/set/delete', () => {
    ...
    it('stores and retrieves a segment', () => {
      em.set(5, 3, 1, { roadType: 5, roadFlags: 0b1010, railType: 0, railFlags: 0, isRamp: false });
    ...
    it('overwrites existing segment', () => {
      em.set(1, 2, 1, { roadType: 3, roadFlags: 0, railType: 0, railFlags: 0, isRamp: false });
      em.set(1, 2, 1, { roadType: 5, roadFlags: 0, railType: 0, railFlags: 0, isRamp: true });
      expect(em.get(1, 2, 1)!.roadType).toBe(5);
      expect(em.get(1, 2, 1)!.isRamp).toBe(true);
    });

    it('different levels are independent', () => {
      em.set(0, 0, 1, { roadType: 1, roadFlags: 0, railType: 0, railFlags: 0, isRamp: false });
      em.set(0, 0, 2, { roadType: 2, roadFlags: 0, railType: 0, railFlags: 0, isRamp: false });
      expect(em.get(0, 0, 1)!.roadType).toBe(1);
      expect(em.get(0, 0, 2)!.roadType).toBe(2);
    });

    it('deletes a segment', () => {
      em.set(3, 4, 1, { roadType: 1, roadFlags: 0, railType: 0, railFlags: 0, isRamp: false });
      em.delete(3, 4, 1);
    ...
    it('rejects level 0', () => {
      expect(() => em.set(0, 0, 0, { roadType: 1, roadFlags: 0, railType: 0, railFlags: 0, isRamp: false }))
        .toThrow();
    });

    it('rejects level > 3', () => {
      expect(() => em.set(0, 0, 4, { roadType: 1, roadFlags: 0, railType: 0, railFlags: 0, isRamp: false }))
        .toThrow();
    });
  });
  ...
  describe('getAllLevels', () => {
    ...
    it('returns all levels for a cell', () => {
      em.set(5, 5, 1, { roadType: 1, roadFlags: 0, railType: 0, railFlags: 0, isRamp: true });
      em.set(5, 5, 3, { roadType: 3, roadFlags: 0, railType: 0, railFlags: 0, isRamp: false });
  ...
  describe('hasElevatedSegment', () => {
    ...
    it('returns true when cell has elevated segment', () => {
      em.set(1, 1, 2, { roadType: 1, roadFlags: 0, railType: 0, railFlags: 0, isRamp: false });
      expect(em.hasElevatedSegment(1, 1)).toBe(true);
    });

    it('returns false after all segments deleted', () => {
      em.set(1, 1, 1, { roadType: 1, roadFlags: 0, railType: 0, railFlags: 0, isRamp: false });
      em.delete(1, 1, 1);
  ...
  describe('getHighestLevel', () => {
    ...
    it('returns the highest level', () => {
      em.set(3, 3, 1, { roadType: 1, roadFlags: 0, railType: 0, railFlags: 0, isRamp: false });
      em.set(3, 3, 3, { roadType: 1, roadFlags: 0, railType: 0, railFlags: 0, isRamp: false });
  ...
  describe('serialization', () => {
    it('round-trips correctly', () => {
      em.set(1, 2, 1, { roadType: 5, roadFlags: 0b0011, railType: 0, railFlags: 0, isRamp: true });
      em.set(3, 4, 2, { roadType: 0, roadFlags: 0, railType: 1, railFlags: 0b1100, isRamp: false });
  ...
  describe('clear', () => {
    it('removes all segments', () => {
      em.set(1, 1, 1, { roadType: 1, roadFlags: 0, railType: 0, railFlags: 0, isRamp: false });
      em.set(2, 2, 2, { roadType: 2, roadFlags: 0, railType: 0, railFlags: 0, isRamp: false });
      em.clear();
