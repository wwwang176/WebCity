...
describe('InfraPlacement', () => {
  ...
  describe('getInfraCenter', () => {
    ...
    it('should return center for 9x6 airport_l', () => {
      // Math.floor(9/2)=4, Math.floor(6/2)=3
      expect(getInfraCenter(5, 5, 'airport_l', 0)).toEqual({ cx: 9, cy: 8 });
    });
  ...
  describe('getInfraCenterById', () => {
    ...
    it('should compute center for 9x6 airport_l by buildingId', () => {
      expect(getInfraCenterById(0, 0, 235)).toEqual({ cx: 4, cy: 3 });
    });
