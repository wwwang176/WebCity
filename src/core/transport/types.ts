...
export interface TransportRoute {
  ...
  // Headway is deliberately not a field. It is cycle time / vehicle count, computed at the
  // point of use by RouteLoad.computeHeadway. As a field it would have to be recomputed at
  // every site that touches a route, and the add-vehicle path would miss it: adding a
  // vehicle would raise the capacity ceiling without shortening the wait at all.
