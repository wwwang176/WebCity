...
export const VEHICLE_CONFIG: Record<string, VehicleTypeConfig> = {
  ...
  ambulance:      { color: 0xffffff, frontOffset: 0.13, rearOffset: 0.13, yPosition: 0.025, buildGeometry: buildAmbulanceGeometry },
  garbage_truck:  { color: 0x2e7d32, frontOffset: 0.16, rearOffset: 0.16, yPosition: 0.025, buildGeometry: buildGarbageTruckGeometry },
