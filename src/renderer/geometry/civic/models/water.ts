...
/** 儲水塔。降過一次高度：15.0 → 10.5 m。 */
const TOWER_TOP = M(10.5);
 ...
 *
 * 塔身與塔頂**都**走 `PART_SHELL`，而且顏色是**純白**。在那之前
 * 塔身是牆，被 `FACADE_UTILITY` 壓成 0.70～0.90 倍再加一條高窗帶；
...
const massing: CivicVolume[] = [
  ...
  },
  {
    ...
    x: M(7.4), z: M(5.7), w: M(5.4), d: M(5.4), y0: TOWER_TOP, y1: M(10.9),
  },
  {
    tag: 'beacon', part: PART_LAMP, shape: 'cylinder',
    x: M(7.4), z: M(5.7), w: M(0.8), d: M(0.8), y0: M(10.9), y1: M(11.3),
  },
];
